...
#pragma warning restore 0649
        ...
        public string     deviceModel { get { return                    _model.deviceModel; } set { _model.deviceModel =                  value;  } }
...
#pragma warning restore 0649
    ...
    public class RealtimeAvatarModel : IModel {
        ...
        public  string  deviceModel {
            get { return _cache.LookForValueInCache(_deviceModel, entry => entry.deviceModelSet, entry => entry.deviceModel);  }
            set { _cache.UpdateLocalCache(entry => { entry.deviceModelSet = true; entry.deviceModel = value; return entry; }); }
        }
        ...
        public int WriteLength(StreamContext context) {
            ...
            if (context.fullModel) {
                ...
                // Device model
                length += WriteStream.WriteStringLength((uint)Properties.DeviceModel, _deviceModel);
            } else {
                // Active state
                if (context.reliableChannel) {
                    ...
                    if (entry.deviceModelSet)
                        length += WriteStream.WriteStringLength((uint)Properties.DeviceModel, entry.deviceModel);
                }
            }
        ...
        public void Write(WriteStream stream, StreamContext context) {
            if (context.fullModel) {
                ...
                // Device model
                stream.WriteString((uint)Properties.DeviceModel, _deviceModel);
            } else {
                // Active state
                if (context.reliableChannel) {
                    ...
                    if (entry.deviceModelSet)
                        stream.WriteString((uint)Properties.DeviceModel, entry.deviceModel);
                }
            }
        }
            ...
            while (stream.ReadNextPropertyID(out propertyID)) {
                switch (propertyID) {
                    ...
                    case (uint)Properties.DeviceType:
                        ...
                        break;
                    case (uint)Properties.DeviceModel:
